# BG Matchmaker - Development Guide with Task Master AI
...
- **Task Management**: Task Master AI for tracking development progress
...
- `/.taskmaster/tasks/tasks.json`: Current development tasks and subtasks
