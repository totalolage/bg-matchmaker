        ...
        availability: [
          {
            ...
            intervals: [{ start: 1080, end: 1320, type: "available" }], // 6pm-10pm
          },
        ],
      },
      {
        ...
        availability: [
          {
            date: new Date().toISOString().split("T")[0],
            intervals: [{ start: 780, end: 960, type: "available" }], // 1pm-4pm
          },
        ],
      },
      {
        ...
        availability: [
          {
            date: new Date().toISOString().split("T")[0],
            intervals: [{ start: 600, end: 840, type: "available" }], // 10am-2pm
          },
        ],
      },
    ];
